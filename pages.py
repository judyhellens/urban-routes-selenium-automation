...
class UrbanRoutesPage:
    ...
    taxi_option_locator = (By.XPATH, '//button[contains(text(),"Chamar um táxi")]')
    comfort_icon_locator = (By.XPATH, '//div[text()="Comfort"]/ancestor::div[contains(@class,"tcard")]')
    ...
    code_confirm_field = (By.XPATH, '//button[contains(text(),"Confirmar")]')
    ...
    # Pedir lençóis e cobertor (⚠️ locator incompleto - precisa corrigir depois)
    switch_blanket = (
        By.XPATH,
        '//div[contains(text(),"Cobertor")]/ancestor::div[contains(@class,"reqs")]//div[contains(@class,"switch")]'
    )

    switch_blanket_checkbox = (
        By.XPATH,
        '//div[contains(@class,"r-sw-label") and contains(.,"Cobertor")]'
    ...
    def click_number_text(self, telefone):
        ...
        code_input = WebDriverWait(self.driver, timeout=5).until(
        ...
        # Confirma código
        self.driver.find_element(*self.code_confirm_field).click()
